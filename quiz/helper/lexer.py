import math
from quiz.helper.ComplCal import *
from quiz.helper.complex import *
...
_FUNCTIONS = {
    ...
    'sin': CalculateTrigonometry.sin,
    'sinh': math.sinh,
    'sqrt': math.sqrt,
    'tan': CalculateTrigonometry.tan,
    'tanh': math.tanh,

    # Sorting
    'get_min': Sorting.get_min,
    'get_max': Sorting.get_max,

    #Tambahan
    'fpb': CalculateNumber.fpb,
    'kpk': CalculateNumber.kpk,
    #Tambahan

    # other
    'faktorial': math.factorial,
    'permutasi': OtherFunction.permutasi,
    'kombinasi': OtherFunction.kombinasi
}
